            ...
            <Col span={24}>
              <Wrapper>
                <Row style={{ textAlign: 'center' }}>
                  <Col span={1} style={{ padding: '0.5em', marginRight: '1.5em' }} onClick={() => { this.handleChart(1) }} className={selected === 1 ? "currencyType slt-currencyType" : "currencyType"}>1D</Col>
                  <Col span={1} style={{ padding: '0.5em', marginRight: '1.5em' }} onClick={() => { this.handleChart(7) }} className={selected === 7 ? "currencyType slt-currencyType" : "currencyType"}>1W</Col>
                  <Col span={1} style={{ padding: '0.5em', marginRight: '1.5em' }} onClick={() => { this.handleChart(30) }} className={selected === 30 ? "currencyType slt-currencyType" : "currencyType"}>1M</Col>
                  <Col span={1} style={{ padding: '0.5em', marginRight: '1.5em' }} onClick={() => { this.handleChart(365) }} className={selected === 365 ? "currencyType slt-currencyType" : "currencyType"}>1Y</Col>
                  <Col span={1} style={{ padding: '0.5em', marginRight: '1.5em' }} onClick={() => { this.handleChart(0) }} className={selected === 0 ? "currencyType slt-currencyType" : "currencyType"}>All</Col>
                </Row>
              </Wrapper>
            </Col>
            <Col span={24}>
